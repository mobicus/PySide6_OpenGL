...
class RenderWidget(QOpenGLWidget):
    ...
    def initializeGL(self):
        ...
        self.texture1.setWrapMode(QOpenGLTexture.ClampToEdge)
        self.texture1.setMinificationFilter(QOpenGLTexture.Linear)
        ...
        self.texture2.setMinificationFilter(QOpenGLTexture.Linear)
